...
function Header() {
	return (
		<div id="home" className="app__header app__flex">
			<motion.div animate={{ x: [-100, 0], opacity: [0, 1] }} transition={{ duration: 0.5 }} className="app__header-info">
			...
			<motion.div animate={{ opacity: [0, 1] }} transition={{ duration: 0.5, delayChildren: 0.5 }} className="app__header-img">
